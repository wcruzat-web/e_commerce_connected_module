{{-- CRUZAT — dashboard topbar: notifications, user info --}}

<div class="bg-white border-b border-gray-200 px-4 lg:px-6 py-3 flex items-center justify-end relative">
    {{-- Mobile hamburger --}}
    <button type="button" class="lg:hidden mr-auto text-gray-500 hover:text-gray-700" onclick="toggleMobileSidebar()">
