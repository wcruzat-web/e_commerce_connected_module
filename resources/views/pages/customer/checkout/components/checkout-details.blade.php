...
<div class="lg:col-span-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-5 shadow-sm h-fit">
    <div class="flex items-center gap-2 mb-5">
        ...
        <h2 class="text-sm font-semibold text-gray-900 dark:text-white">Checkout Details</h2>
    </div>
    ...
    <form method="POST" action="{{ route('checkout.store') }}" class="space-y-4">
        ...
        <div>
            <label class="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-2">Shipping Address</label>
