...
<footer class="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 mt-20 text-xs text-gray-500 dark:text-gray-400">
    <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
        <div>
            <h4 class="font-extrabold text-slate-900 dark:text-white mb-3 text-xs uppercase tracking-wider">Processors</h4>
        ...
        <div>
            <h4 class="font-extrabold text-slate-900 dark:text-white mb-3 text-xs uppercase tracking-wider">Graphics</h4>
            <ul class="space-y-2 font-medium">
        ...
        <div>
            <h4 class="font-extrabold text-slate-900 dark:text-white mb-3 text-xs uppercase tracking-wider">Platform</h4>
            <ul class="space-y-2 font-medium">
        ...
        <div>
            <h4 class="font-extrabold text-slate-900 dark:text-white mb-3 text-xs uppercase tracking-wider">Support</h4>
            <ul class="space-y-2 font-medium">
