...
<div class="min-h-screen bg-[#f5f5f5] dark:bg-gray-900 py-8 px-4 sm:px-6 lg:px-8" style="font-family: 'Outfit', sans-serif;">
    <div class="max-w-5xl mx-auto space-y-5">

        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Order Tracking</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Real-time updates on your ShopEase order.</p>
        </div>
