<div class="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3" style="font-family: 'Outfit', sans-serif;">
    ...
    <div id="chatModal" class="w-80 sm:w-88 bg-white rounded-2xl shadow-xl border border-gray-200" style="display:none;height:420px!important;overflow:hidden!important;flex-direction:column!important">
        ...
        <div id="chatMessages" class="p-4 space-y-3" style="flex:1!important;overflow-y:auto!important;min-height:0!important">
            ...
            <div id="chatMenuArea" class="pl-9 space-y-2">
                <button type="button" onclick="sendChatMessage('refund')" class="w-full flex items-center gap-2.5 bg-white border border-gray-200 rounded-xl px-3.5 py-2.5 hover:border-blue-300 hover:shadow-sm transition-all text-left group">
                    <span style="font-size:15px;line-height:1">🔄</span>
                    <span class="text-xs font-medium text-gray-700 group-hover:text-gray-900">Refund / Return Problem</span>
                </button>
                <button type="button" onclick="sendChatMessage('support')" class="w-full flex items-center gap-2.5 bg-white border border-gray-200 rounded-xl px-3.5 py-2.5 hover:border-blue-300 hover:shadow-sm transition-all text-left group">
                    <span style="font-size:15px;line-height:1">📞</span>
                    <span class="text-xs font-medium text-gray-700 group-hover:text-gray-900">Talk to Support</span>
                </button>
            </div>
        </div>

        <div class="px-4 py-2 border-t border-gray-100 text-center" style="flex-shrink:0!important">
            <span class="text-[10px] text-gray-400">ERP Customer Service Management</span>
        </div>
    </div>
