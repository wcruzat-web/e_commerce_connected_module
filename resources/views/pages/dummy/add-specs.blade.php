            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <template x-for="(spec, index) in specs" :key="index">
                    <div class="flex gap-3 mb-3 items-start">
                        ...
                        <input type="text" x-model="spec.label" placeholder="Attribute name (e.g. GPU Architecture)" class="border rounded px-3 py-2 flex-1">
                        <input type="text" x-model="spec.value" placeholder="Value (e.g. 24GB)" class="border rounded px-3 py-2 flex-1">
