{{-- HAINZ — header: rebuilt with mega menu, search toggle, mobile nav (ERPV1.1); dynamic categories from DB, trending section (ERPV1.2); search input + doSearch() (ERPV1.4) --}}
...
<header class="bg-blue-900 relative z-50" style="font-family: 'Outfit', sans-serif;">
    <div class="border-b border-white/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between py-2 text-[10px] sm:text-xs text-white/90">
            <p>
                {{ $promoBanner->title ?? 'Free on orders over ₱3,000' }}
                &nbsp;|&nbsp;
                {{ $promoBanner->subtitle ?? 'Next-Day Delivery Available' }}
            </p>
