...
@php
    $isEdit = true;
    $formAction = route('payment-methods.update', $method->payment_method_id);
...
<div class="max-w-4xl mx-auto">
    ...
    <h1 class="text-3xl font-bold mt-4">Edit Payment Method</h1>
    <p class="text-gray-500 mt-2">Update your saved payment method details.</p>

    <form class="bg-white rounded-xl shadow mt-8 p-8" method="POST" action="{{ $formAction }}">
        @csrf
        @method('PUT')

        <h2 class="font-bold text-lg mb-4">1. Payment Method</h2>
        ...
        <div class="flex justify-end gap-4">
            ...
            <button type="submit" class="bg-sky-500 hover:bg-sky-600 text-white px-6 py-3 rounded-lg inline-flex items-center gap-2">
                Update Payment Method <span>&rarr;</span>
            </button>
        </div>
