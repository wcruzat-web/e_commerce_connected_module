...
<div id="{{ $id }}" class="{{ $class }}">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 mb-5">
    <div class="bg-white rounded-xl border border-gray-200 p-4">
      ...
      <div class="text-2xl font-bold text-slate-900" id="statTotalProduct">1,247</div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4">
      ...
      <div class="text-2xl font-bold text-slate-900" id="statAvailableStock">18,492</div>
      <div class="text-xs text-emerald-500 font-medium mt-1 flex items-center gap-1">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><line x1="12" y1="19" x2="12" y2="5"/><polyline points="5 12 12 5 19 12"/></svg>
        +321 vs. last month
      </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4">
      ...
      <div class="text-2xl font-bold text-slate-900" id="statLowStock">23</div>
      <div class="text-xs text-red-500 font-medium mt-1 flex items-center gap-1">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4">
      ...
      <div class="text-2xl font-bold text-slate-900" id="statOutOfStock">8</div>
      <div class="text-xs text-emerald-500 font-medium mt-1 flex items-center gap-1">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><line x1="12" y1="19" x2="12" y2="5"/><polyline points="5 12 12 5 19 12"/></svg>
        -2 vs. last month
      </div>
  ...
  <div class="grid grid-cols-1 xl:grid-cols-[1fr_320px] gap-4 mb-5">
    <div class="bg-white rounded-xl border border-gray-200 p-4">
      ...
      <div class="relative">
        <svg id="revenueChart" viewBox="0 0 600 220" class="w-full h-56"></svg>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4">
      ...
      <svg id="categoryChart" viewBox="0 0 320 220" class="w-full h-56"></svg>
    </div>
  </div>
