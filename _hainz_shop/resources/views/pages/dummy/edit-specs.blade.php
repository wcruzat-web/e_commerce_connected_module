...
<body class="bg-gray-100 p-8">
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <template x-for="(spec, index) in specs" :key="index">
                    <div class="flex gap-3 mb-3 items-start">
                        ...
                        <input type="text" x-model="spec.attribute_name" placeholder="Attribute name" class="border rounded px-3 py-2 flex-1">
                        <input type="text" x-model="spec.attribute_value" placeholder="Value" class="border rounded px-3 py-2 flex-1">
    ...
    <script>
        function specsForm() {
            return {
                specs: @json($product->specifications->map(fn($s) => ['category_name' => $s->category_name, 'attribute_name' => $s->attribute_name, 'attribute_value' => $s->attribute_value])),
