<aside class="space-y-6">
    ...
    <div class="lg:hidden">
        <button @click="filterOpen = !filterOpen" class="w-full flex items-center justify-between bg-white rounded-[20px] border border-gray-200/80 p-4 shadow-sm text-sm font-bold text-slate-800">
            <span>Filters</span>
            <svg class="w-4 h-4 transition-transform" :class="filterOpen ? 'rotate-180' : ''" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"></path></svg>
        </button>
    </div>
    <div :class="filterOpen || 'hidden lg:block'">
