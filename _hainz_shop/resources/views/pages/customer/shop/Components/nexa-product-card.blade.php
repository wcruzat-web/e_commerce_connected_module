<div class="bg-white rounded-2xl border border-gray-200/80 p-5 shadow-sm flex flex-col justify-between transition hover:shadow-md relative"
    ...
    <div>
        ...
        <p class="text-[10px] font-semibold text-slate-500 mt-0.5" x-text="product.brand"></p>

        <div class="flex flex-wrap gap-1 mt-2">
            <template x-if="product.category === 'Processors'">
                <div class="flex flex-wrap gap-1 w-full">
                    <span class="bg-blue-100 text-[8.5px] text-blue-700 px-1.5 py-0.5 rounded font-semibold" x-text="product.brand"></span>
                    <span class="bg-blue-100 text-[8.5px] text-blue-700 px-1.5 py-0.5 rounded font-semibold" x-show="product.chipset" x-text="'Chipset: ' + product.chipset"></span>
                    <span class="bg-blue-100 text-[8.5px] text-blue-700 px-1.5 py-0.5 rounded font-semibold" x-show="product.socket" x-text="'Socket: ' + product.socket"></span>
                </div>
            </template>
            <template x-if="product.category !== 'Processors'">
    ...
    <div class="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between">
        <div>
            ...
            <p x-show="product.inStock" class="text-[9px] text-green-600 font-semibold mt-0.5" x-text="product.stock + ' in stock'"></p>
        </div>
