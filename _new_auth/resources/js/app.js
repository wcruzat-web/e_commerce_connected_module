...
/* =========================================================================
   i18n — lightweight EN / FIL dictionary applied via [data-i18n] keys.
   ========================================================================= */
const I18N = {
    en: {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ---------------------------------------------------------------
    // Low-level POST helper (JSON-friendly) for AJAX forms.
    // ---------------------------------------------------------------
    ...
    // ---------------------------------------------------------------
    // AJAX cart / wishlist add + cart update/remove (existing behaviour)
    // ---------------------------------------------------------------
    ...
    // ---------------------------------------------------------------
    // Product heart toggle (products grid + product detail)
    // ---------------------------------------------------------------
    ...
    // ---------------------------------------------------------------
    // Wishlist page — delete / move single item, plus bulk actions
    // ---------------------------------------------------------------
    const pruneWishlist = () => {
    ...
    // ---------------------------------------------------------------
    // Settings — live theme + language toggle, auto-saved on change
    // (so the choice persists across every page without clicking Save)
    // ---------------------------------------------------------------
