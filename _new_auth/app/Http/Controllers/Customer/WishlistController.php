...
class WishlistController extends Controller
{
    ...
    /**
     * Add the product (from the storefront catalog) to the customer's wishlist.
     * De-duplicates per product. Supports AJAX (JSON) and normal posts.
     */
    ...
    /**
     * Toggle a catalog product in/out of the wishlist (used by the
     * heart button on the product / products / home pages). Returns the
     * new "added" state so the front-end can flip the icon.
     */
    ...
    /**
     * Move a single wishlist item into the cart, then remove it.
     */
